...
const filteredFiles = computed(() => {
  ...
  if (selectedType.value !== "all") {
    result = result.filter((f) => {
      ...
      if (selectedType.value === "documents")
        return (
          f.type?.includes("pdf") ||
...
const getUploaderName = (file: any) => {
  ...
  const name = [file.uploaded_by.first_name, file.uploaded_by.last_name]
    .filter(Boolean)
    .join(" ");
  ...
  <div class="space-y-6">
    ...
    >
      <div>
        ...
        <p class="text-slate-600 mt-1">
          View all uploaded files across clients
        </p>
      </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
      <Card class="p-4">
        <div class="flex items-center gap-3">
          <div
            class="w-9 h-9 rounded-lg bg-primary-100 flex items-center justify-center"
          >
      ...
      <Card class="p-4">
        <div class="flex items-center gap-3">
          <div
            class="w-9 h-9 rounded-lg bg-blue-100 flex items-center justify-center"
          >
    ...
    <Card>
      ...
      <div v-else class="divide-y divide-slate-200">
        ...
        >
          <div
            class="w-10 h-10 rounded-lg bg-slate-100 border border-slate-200 flex items-center justify-center flex-shrink-0"
          >
            <Icon
