    ...
    <Card>
      ...
      <div v-else-if="filteredSubmissions.length === 0" class="p-8 text-center">
        ...
        <p class="text-slate-500">
          {{
            searchQuery || selectedStatus !== "all" || selectedForm !== "all"
        ...
        <div v-for="sub in filteredSubmissions" :key="sub.id">
          ...
          >
            <div class="flex items-center gap-4 flex-1 min-w-0">
              <div
                class="w-10 h-10 rounded-lg bg-primary-100 flex items-center justify-center flex-shrink-0"
              >
                <Icon
              ...
              <div class="flex-1 min-w-0">
                ...
                <div
                  class="flex items-center gap-3 mt-1 text-sm text-slate-500"
                >
