  ...
  <div class="space-y-6">
        ...
        >
          ...
          <div class="flex items-center gap-2">
            ...
            <div class="relative group">
              ...
              <div
                class="absolute right-0 top-full mt-1 w-48 bg-white rounded-lg shadow-lg border border-slate-200 py-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-10"
              >
                <NuxtLink
                  :to="`/admin/forms/${form.id}`"
          ...
          >
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  v-model="sendMessage"
                  placeholder="Hi, please complete this form at your earliest convenience..."
                  rows="3"
                />
              </div>
            </div>
            ...
            <div class="flex justify-end gap-3 pt-2">
              <Button variant="secondary" @click="showSendDialog = false"
                >Cancel</Button
              >
              <Button
    ...
    <div class="space-y-6">
      ...
      >
        <div>
          ...
          <p class="text-slate-500 mt-1 text-sm">
            Use these pre-built templates to quickly create forms for collecting
            client information. Customize fields after creation.
          </p>
        </div>
      ...
      <div v-for="category in filteredCategories" :key="category.key">
        <Card class="p-6">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <button
              v-for="template in filteredTemplates.filter(
            ...
            >
              ...
              >
                <Icon
                  :name="template.icon"
                  :class="['w-5 h-5', template.iconColor]"
                />
              </div>
              <div class="min-w-0">
                <p
                  class="font-medium text-slate-900 group-hover:text-primary-700 transition-colors"
                >
                  {{ template.title }}
                </p>
      ...
      <p class="text-xs text-slate-400 leading-relaxed">
        ...
        constitute tax advice. We recommend seeking advice from a tax
        professional for information regarding your personal tax situation.
      </p>
    </div>
  </div>
</template>
