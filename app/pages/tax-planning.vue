...
// Business type options (shared between Steps 3 and 4)
...
// Tax Services Questionnaire — matches Cognito Forms structure exactly
const defaultForm = {
  id: 0,
...
// Step conditions use includes_any to check the checkbox_group "services" array
