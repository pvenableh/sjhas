...
useSeoMeta({
  ...
  description:
    "Securely upload your tax documents, W-2s, 1099s, and other financial documents to SJHAS, Inc.",
});
</script>
SJHAS, Inc.
<template>
  <div class="min-h-screen t-bg">
    ...
    <section class="t-hero py-20 lg:py-28">
      <div class="container-wide section-padding text-center">
        <div
          class="inline-flex items-center gap-2 px-4 py-2 rounded-full t-hero-badge text-sm font-medium mb-6"
        >
    ...
    <section class="py-12 lg:py-20">
      <div class="container-narrow section-padding">
        <Card class="p-6 sm:p-8 lg:p-10">
          <FormsDynamicForm :form="displayForm" @submitted="handleSubmitted" />
        </Card>
        ...
        <div class="mt-8 flex items-start gap-3 text-sm t-text-muted">
          ...
          />
          <p>
            Your documents are transmitted securely and stored in our protected
            system. We take your privacy seriously and will never share your
